  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      <input {...register(id, { required: true })}
        className={`rounded-[10px] text-xs opacity-60 pl-4 mt-2 mb-3 bg-lightGray w-[291px] h-[42px] focus:outline-none ${errors[id]?.type === 'required' && 'border border-deleteButton mb-0'}`}
        id={id}
